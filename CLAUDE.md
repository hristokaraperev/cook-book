...
When starting to work on a new issue always create a new branch: <fix|feature|or something else>/<short description of the issue> on a new git worktree to work from.
